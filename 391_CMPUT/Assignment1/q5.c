...
int q5_create_tempTable(sqlite3 *, sqlite3_stmt *);
...
int main(int argc, char ** argv) {
	...
	sqlite3_stmt  *stmt;
		...
		rc = q5_create_tempTable(db, stmt);
		if( rc != OPERATION_SUCCESS ) {
			return 1;
		}
...
int q5_create_tempTable(sqlite3 *db, sqlite3_stmt *stmt) {
